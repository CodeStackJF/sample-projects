import { h as modalManagerKey } from "./keys-BgLwJbLV.js";
import { y as tryOnScopeDispose } from "./dist-DKc2ivHS.js";
import { a as onKeyStroke, o as unrefElement, r as getSSRHandler } from "./dist-9-XTMhb-.js";
import { i as getSafeDocument, o as isEmptySlot, r as getModalZIndex } from "./dom-BdUQrX99.js";
import { t as useDefaults } from "./useDefaults-BzP4qZBu.js";
import { t as useId$1 } from "./useId-Fh-Arhb7.js";
import { t as useShowHide } from "./useShowHide-C95Y9EKL.js";
import { t as BCloseButton_default } from "./BCloseButton-B3-IdpNp.js";
import { t as useColorVariantClasses } from "./useColorVariantClasses-DHQvLjek.js";
...
import { t as getElement } from "./getElement-uvhh1lgL.js";
import { n as useActivatedFocusTrap, t as useSafeScrollLock } from "./useSafeScrollLock-PVgSASYu.js";
...
var BModal_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const { showRef, renderRef, renderBackdropRef, hide, show, toggle, computedNoAnimation, transitionProps, backdropTransitionProps, isLeaving, isVisible, trapActive, contentShowing, backdropReady, backdropVisible } = useShowHide({
			modelValue,
			props,
			emit,
			element,
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(ConditionalTeleport_default, {
				...
				default: withCtx(() => [unref(renderRef) || unref(contentShowing) ? (openBlock(), createBlock(Transition, mergeProps({ key: 0 }, unref(transitionProps), { appear: modelValue.value || unref(props).visible }), {
					...
					_: 3
				}, 16, ["appear"])) : createCommentVNode("", true), !unref(props).noBackdrop ? renderSlot(_ctx.$slots, "backdrop", normalizeProps(guardReactiveProps(sharedSlots.value)), () => [unref(renderBackdropRef) ? (openBlock(), createBlock(Transition, normalizeProps(mergeProps({ key: 0 }, unref(backdropTransitionProps))), {
					...
					_: 1
				}, 16)) : createCommentVNode("", true)], void 0, 1) : createCommentVNode("", true)]),
				_: 3
			}, 8, ["to", "disabled"]);
		};
	}
...
//# sourceMappingURL=BModal-NPsCBNo7.js.map