...
import { E as isBefore, H as $ad063034c8620db8$export$d0bdf45af03a6ea3, L as $ad063034c8620db8$export$91b62ebf2ba703ee, N as $d07e34cce18680fd$export$b21e0b124e224484, V as $ad063034c8620db8$export$aa8b41735afcabd2, a as createContent, d as useDateFormatter, g as normalizeHourCycle, h as normalizeDateStep, i as isSegmentNavigationKey, j as $2aaf608024c21ca1$export$680ea196effce5f, l as syncTimeSegmentValues, r as getTimeFieldSegmentElements, s as initializeTimeSegmentValues, t as useDateField, u as useLocale, x as getDefaultTime } from "./useDateField-CQZb799C.js";
...
//#region ../../node_modules/.pnpm/reka-ui@2.10.3_vue@3.5.41_typescript@5.9.3_/node_modules/reka-ui/dist/TimeField/TimeFieldRoot.js
...
var TimeFieldRoot_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const convertedModelValue = computed({
			...
			set(newValue) {
				if (newValue) modelValue.value = modelValue.value && "day" in modelValue.value ? newValue : new $2aaf608024c21ca1$export$680ea196effce5f(newValue.hour, newValue.minute, newValue.second, modelValue.value?.millisecond);
		...
		watch(convertedModelValue, (_modelValue) => {
			if (!isNullish(_modelValue) && (!$ad063034c8620db8$export$91b62ebf2ba703ee(convertedPlaceholder.value, _modelValue) || convertedPlaceholder.value.compare(_modelValue) !== 0)) placeholder.value = _modelValue.copy();
		});
...
//#endregion
//#region ../../node_modules/.pnpm/reka-ui@2.10.3_vue@3.5.41_typescript@5.9.3_/node_modules/reka-ui/dist/TimeField/TimeFieldInput.js
...
//# sourceMappingURL=BTimeField-CbRGjaI6.js.map