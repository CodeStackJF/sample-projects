import { t as accordionInjectionKey } from "./keys-BgLwJbLV.js";
import { n as warn } from "./console-DaUCJgpk.js";
import { c as sortSlotElementsByPosition } from "./dom-BdUQrX99.js";
...
import { r as isReadOnlyArray } from "./object-C7YmCGEm.js";
		...
		const sortAccordionItems = () => {
			...
			if (modelValue.value) {
				if (isReadOnlyArray(modelValue.value)) {
					...
					if (next.length !== modelValue.value.length) warn("BAccordion", "Unknown item id in v-model:", modelValue.value);
					index.value = next;
				} else {
...
//# sourceMappingURL=BAccordion-FuQ6sMFy.js.map