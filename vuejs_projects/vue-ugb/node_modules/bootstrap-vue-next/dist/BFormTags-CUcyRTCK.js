...
import { a as onKeyStroke, m as useFocus } from "./dist-9-XTMhb-.js";
import { t as useDefaults } from "./useDefaults-BzP4qZBu.js";
import { t as useId$1 } from "./useId-Fh-Arhb7.js";
import { t as escapeRegExpChars } from "./stringUtils-CVySsg3y.js";
...
var BFormTags_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const onKeydown = (e) => {
			...
			if ((e.key === "Backspace" || e.key === "Delete") && props.removeOnDelete && inputValue.value === "" && shouldRemoveOnDelete.value && modelValue.value.length > 0) removeTag(modelValue.value[modelValue.value.length - 1]);
		...
		const removeTag = (tag) => {
			...
			modelValue.value = [...modelValue.value.slice(0, tagIndex), ...modelValue.value.slice(tagIndex + 1)];
		};
		__expose({
			blur: () => {
				focused.value = false;
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				}, toDisplayString(modelValue.value.join(", ")), 9, _hoisted_2),
				...
				renderSlot(_ctx.$slots, "default", {
					...
					isLimitReached.value ? (openBlock(), createElementBlock("small", _hoisted_12, toDisplayString(unref(props).limitTagsText), 1)) : createCommentVNode("", true)
				], 8, _hoisted_9)]),
				unref(props).name ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(modelValue.value, (tag, index) => {
...
//# sourceMappingURL=BFormTags-CUcyRTCK.js.map