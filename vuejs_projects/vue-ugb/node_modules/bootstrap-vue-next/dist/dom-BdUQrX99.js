...
var attemptFocus = (el, options = {}) => {
	const isActiveElement = (el) => el === getActiveElement();
	try {
		el.focus(options);
	} catch (e) {
		error("dom", e);
...
//#endregion
export { getSafeWindow as a, sortSlotElementsByPosition as c, getSafeDocument as i, getActiveElement as n, isEmptySlot as o, getModalZIndex as r, isVisible as s, attemptFocus as t };

//# sourceMappingURL=dom-BdUQrX99.js.map