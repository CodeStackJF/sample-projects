import { C as tabsInjectionKey } from "./keys-BgLwJbLV.js";
import { c as sortSlotElementsByPosition, i as getSafeDocument } from "./dom-BdUQrX99.js";
import { t as useDefaults } from "./useDefaults-BzP4qZBu.js";
import { t as useId$1 } from "./useId-Fh-Arhb7.js";
import { t as flattenFragments } from "./flattenFragments-B15oMVs-.js";
import { n as BvEvent } from "./classes-BEWWGbj5.js";
	...
	setup(__props, { expose: __expose }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(resolveDynamicComponent(unref(props).tag), mergeProps({
				...
				default: withCtx(() => [showSlot.value ? renderSlot(_ctx.$slots, "default", {}, void 0, void 0, 0) : createCommentVNode("", true)]),
				_: 3
			}, 16, [
				"id",
				"class",
...
var BTabs_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		if (activeIndex.value > -1 && !activeId.value && !selectedTabHasExplicitId.value && tabElementsArray.value.length > 0) {
			...
			if (tabs.value.findIndex((t) => t.id === activeId.value) !== -1) activeIndex.value = tabs.value.findIndex((t) => t.id === activeId.value);
			else updateInitialActiveIndex = true;
		} else if (activeIndex.value > -1 && !activeId.value) {
			if (tabs.value[activeIndex.value]?.id) activeId.value = tabs.value[activeIndex.value]?.id;
