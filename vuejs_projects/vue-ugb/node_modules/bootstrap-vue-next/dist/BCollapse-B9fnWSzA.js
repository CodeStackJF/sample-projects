import { c as collapseInjectionKey } from "./keys-BgLwJbLV.js";
...
var BCollapse_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const { showRef, renderRef, hide, show, toggle, isActive, computedNoAnimation, contentShowing, transitionProps } = useShowHide({
			modelValue,
			props,
			emit,
			element,
			...
			return openBlock(), createElementBlock(Fragment, null, [
				...
				unref(renderRef) || unref(contentShowing) ? (openBlock(), createBlock(Transition, mergeProps({ key: 0 }, unref(transitionProps), {
					...
					default: withCtx(() => [withDirectives((openBlock(), createBlock(resolveDynamicComponent(unref(props).tag), mergeProps({
						...
						default: withCtx(() => [unref(contentShowing) ? renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps(sharedSlots.value)), void 0, void 0, 0) : createCommentVNode("", true)]),
						_: 3
					}, 16, [
						"id",
						"class",
...
//# sourceMappingURL=BCollapse-B9fnWSzA.js.map