import { a as onKeyStroke } from "./dist-9-XTMhb-.js";
import { t as useDefaults } from "./useDefaults-BzP4qZBu.js";
import { n as useLinkClasses, r as useBLinkHelper, t as BLink_default } from "./BLink-mdwZsC7b.js";
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(resolveDynamicComponent(computedTag.value), mergeProps({
				...
				default: withCtx(() => [unref(props).loading ? renderSlot(_ctx.$slots, "loading", {}, () => [!unref(props).loadingFill ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createTextVNode(toDisplayString(unref(props).loadingText), 1)], 64)) : createCommentVNode("", true), renderSlot(_ctx.$slots, "loading-spinner", {}, () => [createVNode(BSpinner_default, {
					small: unref(props).size !== "lg",
					label: unref(props).loadingFill ? unref(props).loadingText : void 0
				}, null, 8, ["small", "label"])])], void 0, 0) : renderSlot(_ctx.$slots, "default", {}, void 0, void 0, 1)]),
				_: 3
			}, 16, [
				"class",
				"aria-disabled",
...
//# sourceMappingURL=BButton-KZu5jczf.js.map