import { n as avatarGroupInjectionKey } from "./keys-BgLwJbLV.js";
...
import { t as useNumberishToStyle } from "./useNumberishToStyle-DCnYcI6A.js";
import { t as useRadiusElementClasses } from "./useRadiusElementClasses-CKCJjpkK.js";
...
var BAvatar_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const SIZES = new Set(Object.freeze([null, ...Object.keys({
			lg: null,
			sm: null
		})]));
		...
		const computedSizeIsLiteralSize = computed(() => !!computedSize.value && SIZES.has(computedSize.value));
...
//# sourceMappingURL=BAvatar-BsStQrBF.js.map