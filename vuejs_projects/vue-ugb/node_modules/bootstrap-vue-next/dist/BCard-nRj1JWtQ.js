...
import { i as omit } from "./object-C7YmCGEm.js";
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(resolveDynamicComponent(unref(props).tag), { class: normalizeClass(["card", computedClasses.value]) }, {
				default: withCtx(() => [
					unref(props).imgPlacement !== "bottom" ? renderSlot(_ctx.$slots, "img", {}, () => [unref(props).imgSrc ? (openBlock(), createBlock(BCardImg_default, normalizeProps(mergeProps({ key: 0 }, imgAttr.value)), null, 16)) : createCommentVNode("", true)], void 0, 0) : createCommentVNode("", true),
					...
					!unref(props).noBody ? (openBlock(), createBlock(BCardBody_default, {
						...
						"title-tag",
						"class"
					])) : renderSlot(_ctx.$slots, "default", {}, () => [createTextVNode(toDisplayString(unref(props).bodyText), 1)], void 0, 3),
					...
					unref(props).imgPlacement === "bottom" ? renderSlot(_ctx.$slots, "img", {}, () => [unref(props).imgSrc ? (openBlock(), createBlock(BCardImg_default, normalizeProps(mergeProps({ key: 0 }, imgAttr.value)), null, 16)) : createCommentVNode("", true)], void 0, 5) : createCommentVNode("", true)
				]),
				_: 3
			}, 8, ["class"]);
		};
...
//# sourceMappingURL=BCard-nRj1JWtQ.js.map