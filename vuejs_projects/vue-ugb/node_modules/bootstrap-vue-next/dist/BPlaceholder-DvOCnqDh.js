...
import { s as BCardImg_default, t as BCard_default } from "./BCard-nRj1JWtQ.js";
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(BTableSimple_default, null, {
				default: withCtx(() => [
					!unref(props).noHeader ? renderSlot(_ctx.$slots, "thead", {}, () => [createElementVNode("thead", null, [createElementVNode("tr", null, [(openBlock(true), createElementBlock(Fragment, null, renderList(computedHeaderColumnsLength.value, (_, i) => {
					...
					}), 128))])])], void 0, 0) : createCommentVNode("", true),
					...
					unref(props).showFooter ? renderSlot(_ctx.$slots, "tfoot", {}, () => [createElementVNode("tfoot", null, [createElementVNode("tr", null, [(openBlock(true), createElementBlock(Fragment, null, renderList(computedFooterColumnsLength.value, (_, l) => {
					...
					}), 128))])])], void 0, 1) : createCommentVNode("", true)
				]),
				_: 3
			});
		};
...
var BPlaceholderWrapper_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return unref(props).loading ? renderSlot(_ctx.$slots, "loading", {}, void 0, void 0, 0) : renderSlot(_ctx.$slots, "default", {}, void 0, void 0, 1);
		};
	}
});
//#endregion
...
//# sourceMappingURL=BPlaceholder-DvOCnqDh.js.map