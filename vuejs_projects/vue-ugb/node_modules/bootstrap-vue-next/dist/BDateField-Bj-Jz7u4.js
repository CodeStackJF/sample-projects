import { S as useVModel } from "./dist-9-XTMhb-.js";
import { t as useDefaults } from "./useDefaults-BzP4qZBu.js";
import { t as useId$1 } from "./useId-Fh-Arhb7.js";
import { D as isBeforeOrSame, E as isBefore, H as $ad063034c8620db8$export$d0bdf45af03a6ea3, N as $d07e34cce18680fd$export$b21e0b124e224484, V as $ad063034c8620db8$export$aa8b41735afcabd2, a as createContent, c as syncSegmentValues, d as useDateFormatter, g as normalizeHourCycle, h as normalizeDateStep, i as isSegmentNavigationKey, j as $2aaf608024c21ca1$export$680ea196effce5f, l as syncTimeSegmentValues, r as getTimeFieldSegmentElements, s as initializeTimeSegmentValues, t as useDateField, u as useLocale, v as areAllDaysBetweenValid, x as getDefaultTime } from "./useDateField-CQZb799C.js";
import { a as useDirection, l as createContext, n as usePrimitiveElement, r as Primitive, t as VisuallyHidden_default } from "./VisuallyHidden-BYzyjJiY.js";
import { r as isNullish, t as useKbd } from "./useKbd-DRsaFU_f.js";
...
//#region ../../node_modules/.pnpm/reka-ui@2.10.3_vue@3.5.41_typescript@5.9.3_/node_modules/reka-ui/dist/TimeRangeField/TimeRangeFieldRoot.js
var [injectTimeRangeFieldRootContext, provideTimeRangeFieldRootContext] = /*#__PURE__*/ createContext("TimeRangeFieldRoot");
function convertValue(value, date = $ad063034c8620db8$export$d0bdf45af03a6ea3($ad063034c8620db8$export$aa8b41735afcabd2())) {
	if (value && "day" in value) return value;
	return $d07e34cce18680fd$export$b21e0b124e224484(date, value);
}
var TimeRangeFieldRoot_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const convertedStartValue = computed({
			...
			set(newValue) {
				if (newValue) startValue.value = startValue.value && "day" in startValue.value ? newValue : new $2aaf608024c21ca1$export$680ea196effce5f(newValue.hour, newValue.minute, newValue.second, startValue.value?.millisecond);
		...
		const convertedEndValue = computed({
			...
			set(newValue) {
				if (newValue) endValue.value = endValue.value && "day" in endValue.value ? newValue : new $2aaf608024c21ca1$export$680ea196effce5f(newValue.hour, newValue.minute, newValue.second, endValue.value?.millisecond);
		...
		const convertedPlaceholder = computed({
			...
			set(newValue) {
				if (newValue) placeholder.value = "day" in placeholder.value ? newValue.copy() : new $2aaf608024c21ca1$export$680ea196effce5f(newValue.hour, newValue.minute, newValue.second, placeholder.value?.millisecond);
				return newValue;
			}
		});
...
//#endregion
//#region ../../node_modules/.pnpm/reka-ui@2.10.3_vue@3.5.41_typescript@5.9.3_/node_modules/reka-ui/dist/TimeRangeField/TimeRangeFieldInput.js
...
//# sourceMappingURL=BDateField-Bj-Jz7u4.js.map