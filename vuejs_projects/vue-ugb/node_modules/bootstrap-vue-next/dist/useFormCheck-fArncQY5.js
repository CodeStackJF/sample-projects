...
var getClasses = (items) => computed(() => {
	...
	return {
		...
		[`form-control-${resolvedItems.size}`]: resolvedItems.size !== void 0 && !resolvedItems.button
	};
});
...
var getLabelClasses = (items) => computed(() => {
	...
	return {
		...
		[`btn-${resolvedItems.size}`]: resolvedItems.button && resolvedItems.size !== void 0
	};
});
...
//# sourceMappingURL=useFormCheck-fArncQY5.js.map