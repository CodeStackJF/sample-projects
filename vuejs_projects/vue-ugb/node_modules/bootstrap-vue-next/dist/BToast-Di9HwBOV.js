...
import { r as useBLinkHelper, t as BLink_default } from "./BLink-mdwZsC7b.js";
...
import { t as BProgress_default } from "./BProgress-BNxYppi-.js";
import { n as useCountdown, t as useCountdownHover } from "./useCountdownHover-BN8vJIQW.js";
...
var BToast_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const { showRef, renderRef, hide, toggle, show, buildTriggerableEvent, computedNoAnimation, isVisible, transitionProps, contentShowing } = useShowHide({
			modelValue,
			props,
			emit,
			element,
		...
		const { isActive, pause, restart, resume, stop, isPaused, value: remainingMs } = useCountdown(countdownLength, props.interval, { immediate: typeof modelValue.value === "number" && !!modelValue.value });
...
//# sourceMappingURL=BToast-Di9HwBOV.js.map