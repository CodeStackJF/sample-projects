import { l as defaultsKey } from "./keys-BgLwJbLV.js";
import { t as error } from "./console-DaUCJgpk.js";
import { c as unbind, i as resolveActiveStatus, l as updateBind, o as resolveContent, s as resolveDirectiveProps, t as bind } from "./floatingUi-BlKoACvc.js";
...
function findComponentParent(vnode, root, suppressNotFoundError = false) {
	...
	if (!walk([root.subTree])) {
		if (!suppressNotFoundError) error("directive-utils", "Could not find original vnode, will not inherit provides");
		return root;
	}
...
//# sourceMappingURL=utils-nRGGHA_i.js.map