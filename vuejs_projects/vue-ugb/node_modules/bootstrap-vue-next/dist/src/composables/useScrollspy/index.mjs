import { m as syncRef } from "../../../dist-DKc2ivHS.js";
import { h as useIntersectionObserver, v as useMutationObserver } from "../../../dist-9-XTMhb-.js";
import { i as getSafeDocument } from "../../../dom-BdUQrX99.js";
import { t as getElement } from "../../../getElement-uvhh1lgL.js";
import { computed, getCurrentInstance, nextTick, onMounted, readonly, ref, shallowRef, toRef, unref, watch } from "vue";
...
var useScrollspy = (content, target, options = {}) => {
	...
	const scrollIntoView = (event, smooth = false) => {
		...
		if (el && resolvedContent.value) {
			if (resolvedContent.value.scrollTo) resolvedContent.value.scrollTo({
				top: el.offsetTop,
