import { x as showHideRegistryKey } from "../../../keys-BgLwJbLV.js";
import { n as warn } from "../../../console-DaUCJgpk.js";
import { h as RX_SPACE_SPLIT, l as RX_HASH, u as RX_HASH_ID } from "../../../constants-Cap5sNf8.js";
import { t as getActiveShowHide } from "../../../registryAccess-YFj5ZD5T.js";
import { n as findProvides } from "../../../utils-nRGGHA_i.js";
import "vue";
...
var handleUpdate = (el, binding, vnode) => {
	...
	if (el.dataset.bvtoggle) {
		...
		for (const targetId of oldTargets) {
			...
			if (!targetsSet.has(targetId)) showHide.unregisterTrigger("click", el, false);
		}
	}
	...
	targets.forEach(async (targetId) => {
		...
		while (count < maxAttempts) {
			...
			if (!showHide) {
				...
				if (el.dataset.bvtoggle) warn("v-b-toggle", `Target with ID ${targetId} not found after 500ms`);
				break;
			}
			if (!el.dataset.bvtoggle) return;
